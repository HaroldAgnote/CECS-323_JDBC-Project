...
public class UserInput
{
    ...
    public static String getWASDC()
    {
        ...
        {
            input = in.next();
            if ( !( input.equalsIgnoreCase( "W" ) || input.equalsIgnoreCase( "A" ) || input.equalsIgnoreCase( "S" ) || input.equalsIgnoreCase( "D" ) || input.equalsIgnoreCase( "C" ) ) )
            {
                System.out.println( "Error - Invalid Input" );
                System.out.println( "Please Try Again" );
            }
    ...
    public static String getWASDQR()
    {
        ...
        {
            input = in.next();
            if ( !( input.equalsIgnoreCase( "W" ) || input.equalsIgnoreCase( "A" ) || input.equalsIgnoreCase( "S" ) || input.equalsIgnoreCase( "D" ) || input.equalsIgnoreCase( "Q" ) || input.equalsIgnoreCase( "R" ) ) )
            {
                System.out.println( "Error - Invalid Input" );
                System.out.println( "Please Try Again" );
            }
